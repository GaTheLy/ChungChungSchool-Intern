                        ...
                        <tbody class="grades-row-group">
                            <tr>
                                ...
                                @foreach($sub_teacher->subject->mypCriteria as $criterion)
                                    @php                                     
                                        $ib_grade = $criterion->mypCriteriaGrades->first();
                                        $local_grade = $conversions->firstWhere('ib_grade', $ib_grade->crit_grade)->local_grade ?? 'N/A';
                                ...
                                @php                                     
                                        $ib_grade_all = $sub_teacher->subject->progress->grade;
                                        $local_grade_all = $conversions->firstWhere('ib_grade', $ib_grade_all)->local_grade ?? 'N/A';
                               
                                    @endphp
                                <td>{{ $local_grade_all }}</td>
